...
def getSOhtml2(skill1, skill2):
	...
	filedata = urllib2.urlopen("http://cs.stackexchange.com/questions/tagged/"+skill1+"+"+skill2)
	data = filedata.read()
...
def getSOhtml1(skill):
    try:
        ...
        filedata = urllib2.urlopen("http://cs.stackexchange.com/questions/tagged/"+skill)
        data = filedata.read()
...
not_to_be_included_skills = ['kernel']
