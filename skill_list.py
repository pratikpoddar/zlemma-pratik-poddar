# Skill List from Stackoverflow and Math.Stackexchange
skill_list=['pattern-recognition', 'opengl', 'c#', 'ruby-on-rails', 'graph', 'fortran', 'matlab', 'multithreading', 'jquery', 'python', 'rake', 'windowspowershell', 'neural-network', 'ms-access', 'linear-programming', 'lisp', 'set-theory', 'mapreduce', 'c++', 'parallel-programming', 'complexity-theory', 'calculus', 'statistical-inference', 'computer-vision', 'mysql', 'nonlinear-optimization', 'numerical-optimization', 'scala', 'algebra', 'functional-analysis', 'mahout', 'optimization', 'amazon-web-services', 'real-analysis', 'computational-geometry', 'javascript', 'ajax', 'apache', 'integer-programming', 'solr', 'search', 'visualbasic', 'convex-analysis', 'geometry', 'text-mining', 'programming', 's', 'swing', 'estimation', 'query-optimization', 'clojure', 'probability', 'haskell', 'linux', 'linear-algebra', 'perl', 'maple', 'genetic-algorithm', 'statistics', 'java', 'combinatorics', 'automata', 'data-structures', 'numerical-methods', 'game-programming', 'scheme', 'discrete-optimization', 'c', 'hive', 'ruby', 'groovy', 'erlang', 'data-mining', 'image-processing', 'r', 'theory-of-computation', 'network-theory', 'prolog', 'approximation-algorithms', 'business-intelligence', 'web-mining', 'actionscript3.0', 'discrete-mathematics', 'convex-optimization', 'number-theory', 'f#', 'measure-theory', 'regression', 'cassandra', 'asp.net', 'servlets', 'mathematica', 'hadoop', 'html', 'machine-learning', 'vhdl', 'bigdata', 'estimation-theory', 'jsp', 'sql', 'php', 'pattern-matching', 'mathematical-modeling', 'algorithm', 'database', 'information-theory', 'django', 'oracle', 'coding-theory', 'formal-methods', 'graphics', 'finite-element-method', 'networks', 'information-retrieval', 'natural-language-processing', 'virtualization', 'differential-equations', 'computational-mathematics', 'time-series', 'programming-languages', 'visualization', 'compiler', 'mathematical-analysis', 'mathematical-physics', 'cryptography', 'software-engineering', 'operating-systems', 'stochastic-calculus', 'control-theory', 'bioinformatics', 'computer-security', 'signal-processing', 'distributed-systems', 'fluid-dynamics', 'computational-chemistry', 'econometrics', 'artificial-intelligence', 'human-computer-interaction', 'game-theory', 'operations-research']
